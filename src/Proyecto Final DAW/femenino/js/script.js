...
// Cambiar entre temas masculino y femenino
function toggleTheme() {
    const body = document.body;
    const themeToggleBtn = document.getElementById("theme-toggle");

    // Alternar la clase `theme-femenino`
    if (body.classList.contains("theme-femenino")) {
        body.classList.remove("theme-femenino");
        themeToggleBtn.textContent = "Cambiar a Tema Femenino";
    } else {
        body.classList.add("theme-femenino");
        themeToggleBtn.textContent = "Cambiar a Tema Masculino";
    }
}
